...
module Thrift
  module Test
    ...
    class MutableException < ::Thrift::Exception; end

    class ExceptionWithoutFields < ::Thrift::Exception; end
    ...
    class CompactProtoTestStruct
      ...
      FIELDS = {
        ...
        FIELD500 => {:type => ::Thrift::Types::I64, :name => 'field500'},
        FIELD5000 => {:type => ::Thrift::Types::I64, :name => 'field5000'},
        FIELD20000 => {:type => ::Thrift::Types::I64, :name => 'field20000'}
      }
    ...
    class MutableException < ::Thrift::Exception
      include ::Thrift::Struct, ::Thrift::Struct_Union
    ...
    class ExceptionWithoutFields < ::Thrift::Exception
      include ::Thrift::Struct, ::Thrift::Struct_Union
